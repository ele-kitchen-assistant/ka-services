...
from kitchen_assistant.common.helpers.datetime import utc_timestamp
from kitchen_assistant.common.helpers.json import serialize_to_json
from kitchen_assistant.common.models.enums import EventType, ProviderFeature
from kitchen_assistant.common.models.errors import MediaNotFoundError, UnsupportedFeaturedException
from kitchen_assistant.common.models.media_items import (
    Album,
    AlbumType,
    Artist,
    ItemMapping,
...
from kitchen_assistant.constants import VARIOUS_ARTISTS, VARIOUS_ARTISTS_ID
from kitchen_assistant.server.controllers.media.base import MediaControllerBase
from kitchen_assistant.server.controllers.music import (
    DB_TABLE_ALBUMS,
    DB_TABLE_ARTISTS,
    DB_TABLE_TRACKS,
)
from kitchen_assistant.server.helpers.compare import compare_artist, compare_strings

if TYPE_CHECKING:
    from kitchen_assistant.server.models.music_provider import MusicProvider
