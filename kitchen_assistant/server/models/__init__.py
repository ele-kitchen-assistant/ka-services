...
from kitchen_assistant.common.models.config_entries import ConfigValueType
...
if TYPE_CHECKING:
    from kitchen_assistant.common.models.config_entries import ConfigEntry, ProviderConfig
